  ...
  <div class="chat">
    <header class="chat__header">
      <div class="chat__heading">
        ...
        <p class="chat__subtitle">
          匿名体验，无需登录 · 城市 {{ city || '不限' }} · 会话 {{ conversationId || '新会话' }} · 访客
          {{ visitorId.slice(0, 8) }}
        </p>
      </div>
      <div class="chat__actions">
        <label class="chat__city">
          <span class="chat__city-label">城市</span>
          <select class="chat__city-select" :value="city" @change="onCityChange">
    ...
    <main ref="listRef" class="chat__list">
      <div v-if="!hasMessages" class="chat__empty">
        ...
        <p>选了城市就按该城市的规则回答，不选城市则不限城市；切换城市会开始一段新对话。</p>
      </div>
